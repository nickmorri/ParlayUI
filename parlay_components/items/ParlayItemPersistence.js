(function () {
    ...
    function ParlayItemPersistenceFactory (ParlayStore) {
        ...
        function find_scope (key, scope) {
            var split_key = key.split('.');
            var scope_attribute = split_key[0];
        ...
        /**
         * Parlay service for persistence of [ParlayItemCard]{@link module:ParlayItem.ParlayItemCard} $scope attributes
         * to [ParlayStore]{@link module:ParlayStore.ParlayStore}.
         * @constructor module:ParlayItem.ParlayItemPersistence
         *
         * @example <caption>Persist the $index attribute, generated by ng-repeat representing it's position amongst
         * elements, to ParlayStore.</caption>
         *
         * ParlayItemPersistence.monitor(directive_name, "$index", scope);
         *
         * @example <caption>Store all values that are currently registered for persistence.</caption>
         *
         * ParlayItemPersistence.store(workspace_name, autosave);
         *
         */
