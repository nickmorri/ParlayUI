        ...
        function PromenadeStandardItem (data, protocol) {
            ...
            if (data.PROPERTIES) {
                this.properties = data.PROPERTIES.reduce(function (accumulator, current) {
                    accumulator[current.PROPERTY] = new PromenadeStandardProperty(current, this.id, protocol, this.name);
                    return accumulator;
                }.bind(this), {});
            }
            ...
            if (data.DATASTREAMS) {
                this.data_streams = data.DATASTREAMS.reduce(function (accumulator, current) {
                    accumulator[current.STREAM] = new PromenadeStandardDatastream(current, this.id, protocol, this.name);
                    return accumulator;
                }.bind(this), {});
            }
